...
public class Exercise2Test extends PetDomainForKata
{
    ...
    {
        Person result = people.detect(p -> p.named("Mary Smith"));
    ...
    {
        MutableList<Person> petPeople = people.select(Person::isPetPerson); //replace with only the pet owners
    ...
    public void getAllPetsOfAllPeople()
    {
        ...
        MutableSet<PetType> petTypes = people.flatCollect(function, Sets.mutable.empty());
        Assert.assertEquals(
