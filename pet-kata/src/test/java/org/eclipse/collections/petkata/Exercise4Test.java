...
public class Exercise4Test extends PetDomainForKata
{
    ...
    public void getAgeStatisticsOfPets()
    {
        ...
        MutableIntList petAges = people.flatCollect(Person::getPets).collectInt(Pet::getAge);
        ...
        Assert.assertEquals(stats.getAverage(), petAges.average(), 0);
    ...
    {
        //find Bob Smith
        Person person = people.detectWith(Person::named, "Bob Smith");
    ...
    public void streamsToECRefactor2()
    {
        ...
        Bag<PetType> countsStream = people.flatCollect(Person::getPets).collect(Pet::getType).toBag();
    ...
    public void streamsToECRefactor3()
    {
        ...
        MutableList<ObjectIntPair<PetType>> favorites = people.flatCollect(Person::getPets).collect(Pet::getType).toBag().topOccurrences(3);
